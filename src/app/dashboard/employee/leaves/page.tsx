  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button
          onClick={() => navigation.push('/dashboard/employee/leaves/create')}
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem
                                  onClick={() =>
                                    navigation.push(`/dashboard/employee/leaves/${leave.id}`)
                                  }
                                >
                                ...
                                {leave.status === 'PENDING' && (
                                  <>
                                    <DropdownMenuItem
                                      onClick={() =>
                                        navigation.push(
                                          `/dashboard/employee/leaves/${leave.id}/edit`
                                        )
                                      }
                                    >
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {leave.status === 'PENDING' && (
                                <>
                                  <DropdownMenuItem
                                    onClick={() =>
                                      navigation.push(`/dashboard/employee/leaves/${leave.id}/edit`)
                                    }
                                  >
                                    <Edit className="mr-2 h-4 w-4" />
                                    Edit
