...
import { GuestSidebar } from '@/components/dashboards/guest-sidebar';
  ...
  return (
    <AuthGuard allowedRoles={['GUEST']}>
      <div className="bg-background flex h-screen overflow-hidden">
        {/* Sidebar */}
        <GuestSidebar isCollapsed={isCollapsed} onToggle={() => setIsCollapsed(!isCollapsed)} />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end" forceMount>
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/dashboard/guest/profile">
