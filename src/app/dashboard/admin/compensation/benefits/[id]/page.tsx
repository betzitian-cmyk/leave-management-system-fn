    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Benefit Details</h1>
            <p className="text-muted-foreground">View benefit information</p>
          </div>
        </div>
        <Button
          onClick={() =>
            navigation.push(`/dashboard/admin/compensation/benefits/${benefitId}/edit`)
          }
          className="cursor-pointer"
        >
