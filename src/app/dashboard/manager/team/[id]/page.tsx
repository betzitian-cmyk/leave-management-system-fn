...
export default function ManagerTeamMemberViewPage() {
    ...
    const fetchEmployee = async () => {
      try {
        ...
        if (response.success && response.data) {
          ...
          toast.error(response.message || 'Failed to load team member details');
        }
      } catch (err) {
  ...
  const handleBack = () => {
    navigation.push('/dashboard/manager/team');
  };
  ...
  if (!employee) {
    return (
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground text-center">Team member not found</p>
          </CardContent>
        </Card>
      </div>
    );
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <p className="text-muted-foreground text-sm">
                    This team member does not have a direct manager
                  </p>
                </div>
              </CardContent>
            </Card>
