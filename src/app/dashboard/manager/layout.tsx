...
import { ManagerSidebar } from '@/components/dashboards/manager-sidebar';
  ...
  return (
    <AuthGuard allowedRoles={['MANAGER']}>
      <div className="bg-background flex h-screen overflow-hidden">
        {/* Sidebar */}
        <ManagerSidebar isCollapsed={isCollapsed} onToggle={() => setIsCollapsed(!isCollapsed)} />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end" forceMount>
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/dashboard/manager/profile">
