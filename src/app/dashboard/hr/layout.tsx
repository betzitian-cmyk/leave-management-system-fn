...
import { HRSidebar } from '@/components/dashboards/hr-sidebar';
...
export default function HRDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AuthGuard allowedRoles={['HR_MANAGER']}>
      <div className="bg-background flex h-screen overflow-hidden">
        {/* Sidebar */}
        <HRSidebar isCollapsed={isCollapsed} onToggle={() => setIsCollapsed(!isCollapsed)} />
