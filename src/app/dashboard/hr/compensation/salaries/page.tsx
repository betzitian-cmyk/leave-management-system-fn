...
export default function HRSalariesPage() {
  ...
  }, [salaries, searchTerm, typeFilter, statusFilter]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={() => navigation.push('/dashboard/hr/compensation/salaries/create')}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(
                                    `/dashboard/hr/compensation/salaries/${salary.id}`
                                  )
                                }
                                className="cursor-pointer"
                              >
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(
                                    `/dashboard/hr/compensation/salaries/${salary.id}/edit`
                                  )
                                }
                                className="cursor-pointer"
                              >
