...
export default function HRBenefitsPage() {
  ...
  }, [benefits, searchTerm, typeFilter, categoryFilter, statusFilter]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage employee benefits and packages</p>
        </div>
        <Button
          onClick={() => navigation.push('/dashboard/hr/compensation/benefits/create')}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(
                                    `/dashboard/hr/compensation/benefits/${benefit.id}`
                                  )
                                }
                                className="cursor-pointer"
                              >
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(
                                    `/dashboard/hr/compensation/benefits/${benefit.id}/edit`
                                  )
                                }
                                className="cursor-pointer"
                              >
