...
export default function HRBonusesPage() {
  ...
  }, [bonuses, searchTerm, typeFilter, statusFilter]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage employee bonuses and incentives</p>
        </div>
        <Button
          onClick={() => navigation.push('/dashboard/hr/compensation/bonuses/create')}
                        ...
                        <TableCell className="text-right">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(`/dashboard/hr/compensation/bonuses/${bonus.id}`)
                                }
                                className="cursor-pointer"
                              >
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  navigation.push(
                                    `/dashboard/hr/compensation/bonuses/${bonus.id}/edit`
                                  )
                                }
                                className="cursor-pointer"
                              >
