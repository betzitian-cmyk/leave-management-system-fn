...
export default function HRBonusViewPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Bonus Details</h1>
        ...
        <Button
          onClick={() => navigation.push(`/dashboard/hr/compensation/bonuses/${bonusId}/edit`)}
